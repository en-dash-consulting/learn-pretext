...
const searchIndex: SearchEntry[] = [
  ...
  { title: 'Word Golf', track: 'Creative', description: 'Remove the fewest words to fit text under a target height. Pretext gives instant height feedback.', keywords: ['golf', 'puzzle', 'words', 'remove', 'height', 'target', 'par', 'score', 'game'], href: '/pages/text-flood.html' },
